window.addEventListener("DOMContentLoaded", () => {
  ...
  function showModalByScroll() {
    if (window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight) { //1 - прокрутка всего окна 2 - видимая часть у пользователя 3 - полная высота сайта
      openModal();
